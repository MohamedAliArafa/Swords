...
//                                            }
    ...
    private void showAlertDialog() {
        ...
        final SimpleAdapter adapter2 = new SimpleAdapter(getBaseContext(), Lang_List
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                switch (Language_ID) {
                    case 1:
                        ...
                        Configuration config2 = new Configuration();
                        config2.locale = locale2;
                        getBaseContext().getApplicationContext().getResources().updateConfiguration(config2, null);
                        finish();
                        startActivity(getIntent());
                        break;
                    case 2:
                        ...
                        Configuration config3 = new Configuration();
                        config3.locale = locale3;
                        getBaseContext().getApplicationContext().getResources().updateConfiguration(config3, null);
                        finish();
                        startActivity(getIntent());
                        break;
                    case 3:
                        ...
                        getBaseContext().getApplicationContext().getResources().updateConfiguration(config4, null);
                        finish();
                        startActivity(getIntent());
                        break;
                    case 4:
                        ...
                        getBaseContext().getApplicationContext().getResources().updateConfiguration(config5, null);
                        finish();
                        startActivity(getIntent());
                        break;
                    default:
